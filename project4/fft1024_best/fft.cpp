...
void fft(DTYPE X_R[SIZE], DTYPE X_I[SIZE], DTYPE OUT_R[SIZE], DTYPE OUT_I[SIZE])
{
	...
	#pragma HLS dataflow
	bit_reverse_func: 	bit_reverse( X_R,  X_I,Stage0_R,Stage0_I);
	stage1_func: 		fft_stage_first(Stage0_R, Stage0_I, Stage1_R, Stage1_I);
	stage2_func: 		fft_stages(Stage1_R, Stage1_I, 2, Stage2_R, Stage2_I);
	stage3_func:		fft_stages(Stage2_R, Stage2_I, 3, Stage3_R, Stage3_I);
	stage4_func:		fft_stages(Stage3_R, Stage3_I, 4, Stage4_R, Stage4_I);
	stage5_func:		fft_stages(Stage4_R, Stage4_I, 5, Stage5_R, Stage5_I);
	stage6_func:		fft_stages(Stage5_R, Stage5_I, 6, Stage6_R, Stage6_I);
	stage7_func:		fft_stages(Stage6_R, Stage6_I, 7, Stage7_R, Stage7_I);
	stage8_func:		fft_stages(Stage7_R, Stage7_I, 8, Stage8_R, Stage8_I);
	stage9_func:		fft_stages(Stage8_R, Stage8_I, 9, Stage9_R, Stage9_I);
	stage10_func:		fft_stage_last(Stage9_R, Stage9_I, OUT_R, OUT_I);
...
void fft_stages(DTYPE X_R[SIZE], DTYPE X_I[SIZE], int stage, DTYPE OUT_R[SIZE], DTYPE OUT_I[SIZE])
{
	...
	*/
	...
	{
		//#pragma HLS loop_tripcount min=2 max=256
...
void fft_stage_last(DTYPE X_R[SIZE], DTYPE X_I[SIZE], DTYPE OUT_R[SIZE], DTYPE OUT_I[SIZE])
{
	...
	loop_last_stage: for(int k = 0; k < SIZE2; k++)
	{
		#pragma HLS pipeline II=1
		#pragma HLS unroll factor=3
