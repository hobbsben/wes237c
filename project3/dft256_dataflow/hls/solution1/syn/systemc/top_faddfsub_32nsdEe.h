...
#ifndef __top_faddfsub_32nsdEe__HH__
#define __top_faddfsub_32nsdEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_faddfsub_32nsdEe) {
    ...
    SC_CTOR(top_faddfsub_32nsdEe):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
