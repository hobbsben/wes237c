...
void top_Stage1_real::proc_tptr() {
    if (reset.read() == SC_LOGIC_1) {
        tptr.write(0);
...
void top_Stage1_real::proc_count() {
    if (reset.read() == SC_LOGIC_1) {
        count.write(0);
...
void top_Stage1_real::proc_full_n() {
    if (reset.read() == SC_LOGIC_1) {
...
void top_Stage1_real::proc_empty_n() {
    if (reset.read() == SC_LOGIC_1) {
