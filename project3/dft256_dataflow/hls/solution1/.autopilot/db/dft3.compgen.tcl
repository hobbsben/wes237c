...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename dft_real \
    op interface \
    ports { dft_real_address0 { O 8 vector } dft_real_ce0 { O 1 bit } dft_real_we0 { O 1 bit } dft_real_d0 { O 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename dft_imag \
    op interface \
    ports { dft_imag_address0 { O 8 vector } dft_imag_ce0 { O 1 bit } dft_imag_we0 { O 1 bit } dft_imag_d0 { O 32 vector } } \
} "
} else {
