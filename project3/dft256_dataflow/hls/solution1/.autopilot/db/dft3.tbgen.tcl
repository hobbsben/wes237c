...
set C_modelArgMapList {[ 
	{ "Name" : "real_sample", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "dft_real", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "dft_imag", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set Spec2ImplPortList { 
	...
	dft_real { ap_memory {  { dft_real_address0 mem_address 1 8 }  { dft_real_ce0 mem_ce 1 1 }  { dft_real_we0 mem_we 1 1 }  { dft_real_d0 mem_din 1 32 } } }
	dft_imag { ap_memory {  { dft_imag_address0 mem_address 1 8 }  { dft_imag_ce0 mem_ce 1 1 }  { dft_imag_we0 mem_we 1 1 }  { dft_imag_d0 mem_din 1 32 } } }
}
